...
<div class="bg-white py-12 border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
                <div class="text-4xl font-bold text-emerald-600 counter" data-target="500">0</div>
                <div class="text-gray-600 mt-2">Products</div>
            </div>
            <div>
                <div class="text-4xl font-bold text-emerald-600 counter" data-target="5000">0</div>
                <div class="text-gray-600 mt-2">Happy Customers</div>
            </div>
            <div>
                <div class="text-4xl font-bold text-emerald-600 counter" data-target="30">0</div>
                <div class="text-gray-600 mt-2">Countries</div>
            </div>
            <div>
                <div class="text-4xl font-bold text-emerald-600 counter" data-target="99">0</div>
...
<div class="bg-gradient-to-r from-red-600 to-pink-600 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl overflow-hidden hover:shadow-2xl transition group">
                <div class="relative">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="{{ route('store.index') }}" class="text-emerald-600 font-semibold hover:text-emerald-700 flex items-center gap-2">
            View All
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm hover:shadow-xl transition group overflow-hidden border-2 border-transparent hover:border-emerald-200">
            <div class="relative aspect-square overflow-hidden">
                ...
                <button 
                    ...
                    class="wishlist-btn absolute top-4 right-4 w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white transition shadow-lg"
                    data-product-id="{{ $product->id }}"
                    data-in-wishlist="{{ $inWishlist ? 'true' : 'false' }}">
                    <svg class="w-5 h-5 {{ $inWishlist ? 'text-red-500 fill-current' : 'text-gray-600' }} hover:scale-110 transition" fill="{{ $inWishlist ? 'currentColor' : 'none' }}" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-4">
                <span class="text-xs text-emerald-600 font-semibold">{{ $product->category->name }}</span>
                <h3 class="font-bold text-gray-900 mt-1 mb-2 line-clamp-2">{{ $product->name }}</h3>
                ...
                <div class="flex gap-2">
                    <a href="{{ route('store.product', $product->slug) }}" class="flex-1 bg-gray-100 text-gray-900 text-center py-2 rounded-lg font-semibold hover:bg-gray-200 transition">
                        View
                    </a>
...
<div class="bg-gray-100 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            <a href="{{ route('store.category', $category->slug) }}" class="bg-white rounded-xl p-6 text-center hover:shadow-lg transition group">
                <div class="w-16 h-16 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                    <span class="text-2xl">🖥️</span>
                </div>
                <h3 class="font-semibold text-gray-900 text-sm mb-1">{{ $category->name }}</h3>
                <span class="text-xs text-gray-600">{{ $category->products_count }} items</span>
            </a>
            @endforeach
        </div>
    </div>
...
<!-- Why Choose Us -->
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <h2 class="text-3xl font-bold text-gray-900 mb-12 text-center">Why Choose Technorics?</h2>
    <div class="grid md:grid-cols-4 gap-8">
        <div class="text-center">
            ...
            <h3 class="font-bold text-gray-900 mb-2">Authentic Products</h3>
            <p class="text-gray-600 text-sm">100% genuine products from authorized dealers</p>
        </div>
        <div class="text-center">
            <div class="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-10 h-10 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-gray-600 text-sm">Free shipping on orders over €100</p>
        </div>
        <div class="text-center">
            <div class="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-10 h-10 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 class="font-bold text-gray-900 mb-2">Best Prices</h3>
            <p class="text-gray-600 text-sm">Competitive pricing with exclusive deals</p>
        </div>
        <div class="text-center">
            <div class="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-10 h-10 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-gray-600 text-sm">Expert customer support anytime</p>
        </div>
    </div>
</div>
